...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Transformer=void 0;function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function _defineProperties(a,b){for(var c,d=0;d<b.length;d++)c=b[d],c.enumerable=c.enumerable||!1,c.configurable=!0,"value"in c&&(c.writable=!0),Object.defineProperty(a,c.key,c)}function _createClass(a,b,c){return b&&_defineProperties(a.prototype,b),c&&_defineProperties(a,c),a}var Transformer=function(){function a(b){_classCallCheck(this,a),this.ops=b||{}}return _createClass(a,[{key:"process",value:function process(a){var b="";for(var c in a.list){var d=a.list[c];if(this.ops[a.type]){var e=this.ops[a.type](d,a);!1!==e&&(b+=e)}else!1!==d&&(b+=d)}return b}}]),a}();exports.Transformer=Transformer;
